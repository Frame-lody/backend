(function() {
    ...
    // let speed;
    let movingSpeed = speed?speed*0.6:0.6;
    ...
    window.sketch = function(p) {
      ...
      class RainDrop {
        constructor(rain) {
          ...
          this.splashTime = 0.0;
          this.splashMax = 1.0;
          this.color1 = changeColors!=0?changeColors[1]:colors[1];
        }
        ...
        update(speed) {
          ...
          if (this.pos.z > p.height - this.pos.y) {
            ...
            let rnd = p.random();
            if (rnd < 0.2) {
              this.color1 = changeColors!=0?changeColors[2]:colors[2];
            } else {
              this.color1 = changeColors!=0?changeColors[1]:colors[1];
            }
          }
        ...
        draw() {
          ...
          p.fill(changeColors!=0?changeColors[0]:colors[0]);
