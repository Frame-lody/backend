...
let palette;
// let speed ;
let movingSpeed = speed?speed*0.75:0.75;
...
p.setup = function() {
  myGraphices = [];
  myGraphices2 = [];
  canvas = p.createCanvas(p.windowWidth*2, p.windowWidth);
  graphics = p.createGraphics(p.windowWidth, p.windowWidth);
...
class MyGraphics {
  constructor(x, y, width, height, changeInterval) {
    ...
    this.changeInterval = changeInterval * (1000/movingSpeed);
