(function () {
    ...
    let originalpalette = ['#FF5F5F', '#F8907C', '#FFC2A7', '#FFEC57', '#9EF2BB', '#6CBAF4', '#4AD0E8'];
    ...
    window.sketch = function (p) {
        ...
        class Hexagon {
            constructor(x, y, r) {
                ...
                this.r = r;
                this.t;
                this.colors = [p.shuffle(palette.concat()), p.shuffle(palette.concat()), p.shuffle(palette.concat())];
                this.shape = [p.random() > 0.5, p.random() > 0.5, p.random() > 0.5];
                this.limit = [
            ...
            getTime(num) {
                ...
                switch (num) {
                    case 0:
                        n = p.dist(this.x, this.y, p.width / 2, p.height / 2) / p.sqrt(p.sq(p.width) + p.sq(p.height));
                        break;
                    case 1:
                        n = this.x / p.width;
                        break;
